...
const Experience = () => {
  return (
    <div className="pb-20 bg-black" id="experience">
<motion.h2
...
{experience.technologies.map((tech,index) =>(
  <span key={index} className="mr-2 mt-4 rounded bg-gray-900 px-2 py-1 text-sm font-medium text-purple-400 border border-gray-800">{tech}</span>
))}
